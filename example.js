...
steamClient.on('logOnResponse', function(logonResp) {
  if (logonResp.eresult == Steam.EResult.OK) {
    ...
    steamFriends.setPersonaName('one tuz'); // to change its nickname
    steamFriends.joinChat('103582791459826473'); // the group's SteamID as a string
  }
});
